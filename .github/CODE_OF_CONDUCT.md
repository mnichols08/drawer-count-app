...
- Or by opening an issue with the `code-of-conduct` label (avoid sharing sensitive details)

Project maintainers will review and handle reports with discretion and confidentiality to the extent possible.
